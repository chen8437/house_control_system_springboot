...
//     * true  为生产环境
//     * */
//    private static boolean testOrProduct = false;
//
//    //初始化配置
//    static{
//        if (testOrProduct) {
...
//        return privateDoGet(url, null, null);
//    }
//
//    /**
//     * 发送get请求；带请求参数
...
//        return privateDoGet(url, null, params);
//    }
//
//    /**
//     * 发送get请求；带请求头和请求参数
...
//            throws Exception {
//        return privateDoGet(url, headers, params);
//    }
//
//
//
...
//        return privateDoPost(url, null, null);
//    }
//
//    /**
//     * 发送post请求；带请求参数
...
//        return privateDoPost(url, null, params);
//    }
//
//    /**
//     * 发送post请求；带请求头和请求参数
...
//            throws Exception {
//        return privateDoPost(url, headers, params);
//    }
//
//
//
...
//     * @throws IOException
//     */
//    private static HttpClientResult privateDoGet(String url, Map<String, String> headers, Map<String, String> params)
...
//     * @throws IOException
//     */
//    private static HttpClientResult privateDoPost(String url, Map<String, String> headers, Map<String, String> params)
...
//
//
//    public static HttpClientResult postCreatechat(String url, Map<String, String> headers, String json) throws Exception{
//    	 // 创建httpClient对象
//        CloseableHttpClient httpClient = HttpClients.createDefault();
//
//        // 创建http对象
